...
## Plan of action
1) I have found a public [dataset](https://public.roboflow.com/object-detection/dice/) of (approximately) isometric images of dice with class labels and bounding boxes. An example is shown below. I will use this dataset for pretraining a yolov5 model in PyTorch;
